...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("mega-cmd-server --do-not-log-to-stdout")
...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("tofi-run | xargs sh -c --"))
...
hl.bind(mainMod .. " + CTRL + T", hl.dsp.group.toggle()) -- tabbed layout

-- Binds for "Alt+tab" with mod key
