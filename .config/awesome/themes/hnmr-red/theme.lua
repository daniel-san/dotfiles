...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/hnmr-red"
theme.wallpaper                                 = theme.dir .. "/wallpaper.jpg"
theme.font                                      = "mononoki 11"
...
theme.border_focus                              = myred --"#6F6F6F"
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(7)), "#343434"),
            arrow("alpha", myred),
            wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)), myred),
            arrow(myred, "#889FA7"),
            ...
            arrow("#889FA7", myred),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), myred),
            arrow(myred, "#889FA7"),
